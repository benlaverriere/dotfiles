...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_ergodox_pretty(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           TG(1),                                          TG(2),          KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           LALT_T(KC_MINUS),
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
  [LAYER_STENO] = {
    ...
    NO_COLOR,      NO_COLOR,      NO_COLOR,      NO_COLOR,      NO_COLOR,
    ACCENT_COLOR,  ACCENT_COLOR,  ACCENT_COLOR,  ACCENT_COLOR,  NO_COLOR,
    STENO_COLOR,   STENO_COLOR,   STENO_COLOR,   STENO_COLOR,   NO_COLOR,
    STENO_COLOR,   STENO_COLOR,   STENO_COLOR,   STENO_COLOR,   NO_COLOR,
